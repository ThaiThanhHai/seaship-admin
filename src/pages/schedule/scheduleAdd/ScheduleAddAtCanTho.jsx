    ...
    const getOrders = async () => {
      try {
        const result = await axios.get(
          "http://localhost:3000/api/v1/orders/cantho?filter=new"
        );
        if (result.data) {
  ...
  return (
    <div className="schedule">
      ...
      <div className="scheduleContainer">
        <Navbar />
        <div className="label-page">Lập lịch giao hàng cho xe máy</div>
...
export default ScheduleAddAtCanTho;
